Here's my scala impl.  I used a multiple pass impl first, going left, then
right, then taking the minimum of the two runs, then realized you can do the
left and right run at the same time by using pointers to each end.
